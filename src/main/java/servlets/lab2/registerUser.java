...
public class registerUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setHeader("Refresh", "5; URL=allUsers");
        ...
        SystemUser su = new SystemUser(login, password, UserType.Regular, login, "", mail);
        
        ddb.systemUsers.add(su);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>New User registered correctly.</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
